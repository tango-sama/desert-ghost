...
const GOAL_ARCHETYPES: Record<Goal, Archetype> = {
  ...
  antiaging: {
    angle: "العناية بشبابكِ",
    benefits: [
      { ic: "🕰️", title: "روتين طويل النفس", text: "منتجات هذه الفئة تُقيَّم بالأشهر لا بالأيام، والانتظام هو ما يصنع الفرق." },
      { ic: "🤝", title: "تعمل معاً", text: "الكولاجين والمكمّلات المضادة للأكسدة تُستعمل جنباً إلى جنب، لا كبدائل عن بعضها." },
      { ic: "☀️", title: "مع العادات اليومية", text: "الحماية من الشمس والنوم الكافي جزء من النتيجة بقدر المكمّل نفسه." },
    ],
    faq: [
      { q: "متى أقيّم النتيجة؟", a: "بعد استعمال منتظم لعدة أشهر. لا نعد بنتيجة في أيام، ولا بنتيجة محددة — فهي تختلف من امرأة لأخرى." },
      { q: "هل أستعملها معاً؟", a: "نعم، هذه الفئة تُستعمل كروتين. اتبعي الجرعة المكتوبة على كل عبوة، ولا تضاعفيها." },
    ],
  },
  energy: {
...
const GOAL_HEADLINE: Record<Goal, string> = {
  ...
  energy: "اخترناها لطاقتكِ ونشاطكِ",
  antiaging: "اخترناها لشبابكِ وحيويتكِ",
};
