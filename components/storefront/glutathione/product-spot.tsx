...
// hero; moved out into its own standalone section (2026-08-06, owner
// request) in exchange for the formula section's diagram/picture now
// showing in the hero instead. See hero.tsx, formula-visual.tsx, and
// product-spot-section.tsx.
