    ...
    <div>
      ...
      <div className={cardCls}>
        ...
        <div className="mb-4 text-[.78rem] text-[var(--ink-3)]">
          صورة العبوة فقط توضع في وسط هذا القسم — العناوين والنصوص حوله (جلوتاثيون، سيستئين، فيتامين C) مكتوبة في
          الصفحة نفسها وليست جزءاً من الصورة. لا تستخدمي صوراً بها كتابة أو تصميم كامل (مثل صور مولّدة بالذكاء
          الاصطناعي تحتوي نصوصاً)، فالنص داخل الصورة يظهر غالباً مشوّهاً وغير قابل للقراءة. اتركيها فارغة للإبقاء على
